...
@section('title', 'Редакция посадочной страницы')
      ...
      <div class="pb-6 border-b border-coolGray-100">
        <div class="flex flex-wrap items-center justify-between -m-2">
          <div class="w-full md:w-auto p-2">
            ...
            <p class="text-xs text-coolGray-500 font-medium">Редакция посадочной страницы</p>
          </div>
          <div class="w-full md:w-auto p-2">
        ...
        <div class="w-full">
          <div class="flex flex-wrap -m-3">
            ...
            <div class="w-full md:flex-1 p-3">
              <input class="@error('name') border-red-500 @enderror w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" id="name" name="name" type="text" value="{{ old('name') ?? $staticpage->name }}" placeholder="Введите заголовок новости">
              @error('name')
      ...
      <div class="py-6 border-b border-coolGray-100">
        <div class="w-full">
          <div class="flex flex-wrap -m-3">
            ...
            <div class="w-full md:flex-1 p-3">
              <input class="@error('cnc') border-red-500 @enderror w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" id="cnc" name="cnc" type="text" value="{{ old('cnc') ?? $staticpage->cnc }}" placeholder="Введите ЧПУ url, который нужен">
              @error('cnc')
                <p class="text-red-500">{{ $message }}</p>
              @enderror
            </div>
